  ...
  return (
    <div className="min-h-screen w-full bg-gray-400 flex flex-col justify-center items-center p-4">
      <div className="w-full max-w-2xl flex flex-wrap justify-center mb-4">
        <div className="w-3/5 sm:w-1/2 md:w-1/4 px-2 py-2 flex flex-col shadow-lg shadow-gray-700">
        ...
        <div className="w-1/3 sm:w-1/2 md:w-1/5 px-2 py-4">
          <button
            type="button"
            className="bg-green-500 w-full h-full rounded-md hover:bg-green-700 hover:text-white shadow-lg shadow-gray-700"
      ...
      <div className="w-full max-w-3xl bg-blue-100 rounded-md p-4 overflow-y-auto h-96 shadow-lg shadow-gray-700">
        {data &&
          data.map((item, index) => (
